   ...
   -->
    ...
    <div class="drawer lg:drawer-open">
      ...
      <div class="drawer-content justify-center bg-base-300 pt-20 lg:pt-0">
        <AppHeaderDecor class="-mt-20 hidden lg:block" />
        <!-- Button -->
        <div
          class="navbar z-[99] lg:hidden top-0 fixed bg-primary shadow-md drawer-button"
        >
          <label
            for="my-drawer-2"
            class="btn btn-square btn-ghost text-base-100 drawer-button lg:hidden"
          >
      ...
      <div class="drawer-side shadow-md">
        ...
        <!-- Top Section -->
        <div class="w-[18rem] py-5 md:py-10 bg-base-200 flex h-dvh flex-col">
          <div class="space-y-8">
            <div class="flex flex-col items-center gap-4">
              <p>Welcome, {{ username }}</p>
              <NuxtLink class="avatar placeholder" to="/home">
                <div
                  class="bg-base-300 text-neutral-content rounded-full w-24 p-4"
                >
                  <AppLogo />
                </div>
              </NuxtLink>
            ...
            <div class="flex flex-col bg-base-200">
              <div class="mx-auto w-40 mb-6">
                <div class="dropdown overflow visible w-40">
                  <label
                    tabindex="0"
                    class="btn btn-primary btn-block text-lg text-no-transform"
                  >
                    <span>
                  ...
                  <ul
                    tabindex="0"
                    class="dropdown-content menu p-2 shadow-lg bg-base-100 z-[1] rounded-box w-40"
                  >
              ...
              <ul class="flex flex-col mx-auto gap-2 w-60 menu">
                <li
                  v-for="n in nav"
                  :key="n.id"
                  class="text-xl"
          ...
          <!-- Bottom -->
          <button
            class="mt-auto lg:mx-8 mx-2 hover:bg-base-300 p-3 rounded-btn"
            @click="logout"
          >
            Sign Out
          </button>
