...
<template>
  <div>
    <BaseContainer class="flex flex-col gap-12 pb-16">
      <section>
        <Subtitle>{{ $t('headers.quickStatistics') }}</Subtitle>
      ...
      <section>
        <Subtitle>{{ $t('headers.recentlyAdded') }}</Subtitle>
      ...
      <section>
        <Subtitle>{{ $t('headers.storageLocations') }}</Subtitle>
      ...
      <section>
        <Subtitle>{{ $t('headers.labels') }}</Subtitle>
